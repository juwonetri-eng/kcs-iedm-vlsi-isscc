...
국내(KCS)와 해외 3대 학회(IEDM·ISSCC·VLSI)의 **발표 논문 3,903편**을 공통 기술분류
(19영역)에 매핑해 국내·해외 연구동향을 비교하는 **정적 단일페이지 대시보드**입니다.
각 논문은 소속 세션의 큐레이션된 분류를 상속합니다. 서버 없이 동작하며 GitHub Pages에
그대로 올릴 수 있습니다. (라이브: https://juwonetri-eng.github.io/kcs-iedm-vlsi-isscc/)
